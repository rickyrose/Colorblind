...
init:
    $ extras_items = ["bg_gallery", "music_room", "cg_gallery"]

    # image button_ch_gallery = At(LiveComposite ((281, 75), (0,0), "gui/ExtrasCharArt-%s.png"), side_eff)
    # image button_ch_gallery_selected_idle = At(LiveComposite ((281, 75), (0,0), "gui/ExtrasCharArt-selected_idle"), side_eff_selected_idle)
    # image button_ch_gallery_selected_hover = At(LiveComposite ((281, 75), (0,0), "gui/side_button_selected.png", (19, 19), "gui/icon_ch_gallery.png",  (77, 18), Text("Characters", style="side_butt")), side_eff_selected_hover)

    image button_bg_gallery = At(LiveComposite ((281, 75), (0,0), "gui/side_button.png",(19, 19), "gui/icon_bg_gallery.png",  (77, 18), Text("BG Art", style="side_butt")), side_eff)
    image button_bg_gallery_selected_idle = At(LiveComposite ((281, 75), (0,0), "gui/side_button_selected.png", (19, 19), "gui/icon_bg_gallery.png", (77, 18), Text("BG Art", style="side_butt")), side_eff_selected_idle)
    image button_bg_gallery_selected_hover = At(LiveComposite ((281, 75), (0,0), "gui/side_button_selected.png", (19, 19), "gui/icon_bg_gallery.png", (77, 18), Text("BG Art", style="side_butt")), side_eff_selected_hover)
    ...
    image button_music_room = At(LiveComposite ((281, 75), (0,0), "gui/side_button.png", (19, 19), "gui/icon_jukebox.png",  (77, 18), Text("Jukebox", style="side_butt")), side_eff)
    image button_music_room_selected_idle = At(LiveComposite ((281, 75), (0,0), "gui/side_button_selected.png", (19, 19), "gui/icon_jukebox.png",  (77, 18), Text("Jukebox", style="side_butt")), side_eff_selected_idle)
    image button_music_room_selected_hover = At(LiveComposite ((281, 75), (0,0), "gui/side_button_selected.png", (19, 19), "gui/icon_jukebox.png",  (77, 18), Text("Jukebox", style="side_butt")), side_eff_selected_hover)

    image button_return = At(LiveComposite ((281, 75), (0,0), "gui/side_button.png", (19, 19), "gui/icon_return.png", (77, 18), Text("Return", style="side_butt")), side_eff)
    image button_return_selected_idle = At(LiveComposite ((281, 75), (0,0), "gui/side_button_selected.png", (19, 19), "gui/icon_return.png", (77, 18), Text("CG Art", style="side_butt")), side_eff_selected_idle)
    image button_return_selected_hover = At(LiveComposite ((281, 75), (0,0), "gui/side_button_selected.png", (19, 19), "gui/icon_return.png", (77, 18), Text("CG Art", style="side_butt")), side_eff_selected_hover)
